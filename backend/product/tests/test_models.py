...
class TestProduto(TestCase):
    ...
    def test_if_produto_attributes_correctiveness(self):
        ...
        self.assertEqual(type(self.produto_1.valor), bool)
    ...
    def test_values_created_into_produto_table(self):
        ...
        self.assertEqual(self.produto_1.name, "Avaianas Azul")
        self.assertEqual(self.produto_1.descricao, "Sandalia Avaianas azul")
        self.assertEqual(self.produto_2.valor, 15.40)
        self.assertEqual(self.produto_2.name, "Avaianas Vermelha")
        self.assertEqual(self.produto_2.descricao, "Sandalia Avaianas vermelha")
        self.assertEqual(self.produto_2.valor, 15.30)
        self.assertEqual(self.produto_2.name, "Avaianas Branca")
        self.assertEqual(self.produto_2.descricao, "Sandalia Avaianas preta")
        self.assertEqual(self.produto_2.valor, 15.20)
        self.assertEqual(self.produto_2.name, "Avaianas Branca")
        self.assertEqual(self.produto_2.descricao, "Sandalia Avaianas branca")
